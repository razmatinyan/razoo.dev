...
export interface MetadataFieldsApiResponse
	extends AdminApiPaginationResponse,
		AdminApiBaseResponse {
...
export namespace v2 {
	...
	namespace api {
		...
		function add_related_assets(
			public_id: string,
			public_ids_to_relate: string | Array<string>,
			options?: AdminApiOptions,
			callback?: ResponseCallback
		): Promise<NewAssetRelationResponse>;
		...
		function delete_related_assets(
			public_id: string,
			public_ids_to_unrelate: string | Array<string>,
			options?: AdminApiOptions,
			callback?: ResponseCallback
		): Promise<DeleteAssetRelation>;

		function delete_related_assets_by_asset_id(
			asset_id: string,
			public_ids_to_unrelate: string | Array<string>,
			options?: AdminApiOptions,
			callback?: ResponseCallback
		...
		function update_metadata_field_datasource(
			field_external_id: string,
			entries_external_id: DatasourceChange,
			options?: AdminApiOptions,
			callback?: ResponseCallback
		...
		function add_metadata_rule(
			rule: MetadataRule,
			options?: AdminApiOptions,
			callback?: ResponseCallback
		): Promise<MetadataRuleResponse>;
		...
		function list_metadata_rules(
			callback?: ResponseCallback,
			options?: AdminApiOptions
		): Promise<MetadataRulesListResponse>;
	...
	namespace uploader {
		...
		function update_metadata(
			metadata: string | Record<any, any>,
			public_ids: string[],
			options?: UploadApiOptions,
			callback?: ResponseCallback
		): Promise<MetadataFieldApiResponse>;
